  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        {/* Amplified orbital animations */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-60">
          <OrbitalDecoration variant="complex" />
        </div>
        
        {/* Additional ambient orbitals */}
        <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 opacity-30">
          <div className="w-[800px] h-[800px] rounded-full border border-synchros-cyan/10 animate-orbit-slow" />
        </div>
        <div className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 opacity-20">
          <div className="w-[600px] h-[600px] rounded-full border border-primary/10 animate-orbit-reverse" />
        </div>
      </div>

      {/* Header */}
      <header className="relative z-20 container mx-auto px-6 pt-8">
        <div className="flex items-center justify-between">
          ...
          <a
            href="#demo"
            className="px-5 py-2.5 text-sm font-medium rounded-full bg-gradient-calm text-primary-foreground transition-all duration-300 hover:scale-105 glow-calm"
          >
            Watch Demo
          </a>
        </div>
      ...
      <section className="relative z-10 min-h-screen flex items-center justify-center pt-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            {/* Origin tagline */}
            <p className="text-sm font-mono text-synchros-cyan mb-4 tracking-widest uppercase animate-fade-in-up">
              Project Origin: 1983
            </p>
            
            {/* Main headline - kept from original */}
            <h2 className="text-4xl md:text-6xl lg:text-7xl font-display font-bold mb-6 animate-fade-in-up opacity-0 animation-delay-200">
              Visual Music Through
              <br />
              <span className="text-gradient-calm">Harmonic Motion</span>
            </h2>
      ...
      {/* Stats Section */}
      <section className="relative z-10 py-16 border-y border-muted/20">
        <div className="container mx-auto px-6">
